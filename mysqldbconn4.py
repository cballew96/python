...
def data_collecting():
    ...
    df1 = pd.read_sql("SELECT name, playerid, season, woba FROM players WHERE pitcherHandedness = 'L' && woba > .6", conn)
    visualize_data(df1)
...
def visualize_data(data):
    ...
    plt.plot(data['name'], data['woba'])
    plt.ylabel("woba", fontsize=15)
